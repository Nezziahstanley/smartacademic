// ============================================================
// Lecturer Profile — view, edit, upload photo, change password
// ============================================================
...
(function () {
  ...
  function openEdit() {
    ...
    $('#editSave').addEventListener('click', async () => {
      ...
      const { ok, data } = await api('/api/lecturer/profile', {
        method: 'PUT',
  ...
  function bindPhotoUpload() {
    ...
    input.addEventListener('change', (e) => {
      ...
      reader.onload = (ev) => {
        ...
        img.onload = async () => {
          ...
          try {
            const { ok, data } = await api('/api/lecturer/profile/photo', {
              method: 'POST',
    ...
    if (removeBtn) {
      removeBtn.addEventListener('click', async () => {
        ...
        await api('/api/lecturer/profile/photo', { method: 'DELETE' });
  ...
  function bindPasswordForm() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        const { ok, data } = await api('/api/lecturer/change-password', {
          method: 'POST',
  ...
  function boot() {
    if (window.__lecturerProfileBooted) return;
    window.__lecturerProfileBooted = true;
    console.log('[lecturer/profile] booting...');
    bindPhotoUpload();
    bindPasswordForm();
    load();
  }
